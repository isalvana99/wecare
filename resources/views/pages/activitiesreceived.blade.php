...
<div class="row side" style="margin-left:1px;">
    <div class="col-3 large">
        <div class="list-group" id="list-tab" role="tablist">
            <a class="list-group-item list-group-item-action" href="/activity/you-donated" role="tab" aria-controls="profile"><i class="far fa-money-bill-alt icon"></i>Donation History</a>
            <a class="list-group-item list-group-item-action active" id="list-personal-list" data-toggle="list" href="#list-personal" role="tab" aria-controls="home"><i class="fas fa-money-bill-alt icon"></i>Received History</a>
        </div>
    </div>
                        ...
                        <div class="form-row">
                            <table id="customers">
                                ...
                                <tr style="border-top:2px solid grey;">
                                    ...
                                    <td>Php {{number_format((float)Auth::user()->amountReceived, 2, '.', '')}}</td>
                                </tr>
                                @else
                                <tr>
