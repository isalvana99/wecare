        ...
        <div class="row allpost_area" >
            <div class="col-4 left_panel_main_con" >
                <div class="container left_panel_normal" id="shopping-cart">
                    ...
                    <!-- donor create post -->
                    <a href="/users/profile/{{$user->id}}"><button class="center_create_btn">
                        Go back to {{$user->orgName}}'s posts..
                    </button></a>
                    <!-- donor create post end -->
                    @else
                    <!-- donor create post -->
...
<!--post -->        @foreach($posts as $post)
            ...
            <div class="container">
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body" style="height:auto;">
                                        ...
                                        @if(Auth::user()->id != $post->postUser2Id)
                                        <!-- post report -->
                ...
                <div class="row post_donation_con">
                    ...
                    <form action="/users/profilerepost">
                        <div>
                            <input type="hidden" name="postid" value="{{$post->postId}}">
                            <input type="hidden" name="userid" id="" value="{{$user->id}}">
                            <button type="submit" class="post_donate_button" style="background-color:#565bbb;">Repost</button>
                        </div>
                    </form>
...
<!--post -->        @foreach($posts2 as $post)
            ...
            <div class="container">
                ...
                <div class="row post_donation_con">
                    ...
                    <form action="{{route('repost')}}" method="GET">
                        <div>
                            <input type="hidden" name="postid" value="{{$post->postId}}">
                            <button type="submit" class="post_donate_button" style="background-color:#565bbb;">Repost</button>
                        </div>
