...
.notifbtn2 {
    position:relative;background-color:white !important;color:#1300b9 !important;
    border: 1px solid #1300b9;
}
</style>
<body>
...
<nav class="navbar navbar-expand-lg navbar-fixed-top" id="navbar">
  ...
  <label for=""><a href="\home" class="banner" style="text-decoration:none"><i class="fa fa-cogs" aria-hidden="true"></i>Settings</a></label>                        
