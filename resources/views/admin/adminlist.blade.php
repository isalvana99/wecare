        ...
        <div class="row inner_main_con">
            <div class="container tab_outer_con">
                ...
                <div class="row tab_head_row">
                    <div class="col-3 " >
                        <button class="selected_tab" style="width:100%;" disabled>Admin Name List</button>
                    </div>
                    <div class="col-3" style="width:100%">
                        <form action="{{route('Settings 2')}}" method="GET"><input type="hidden" name="selected_tile" value="Settings"><button class="normal_tab" style="width:100%;">My Profile</button></form>
                    </div>
                </div>
