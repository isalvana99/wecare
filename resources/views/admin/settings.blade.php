...
<div class="col-9 big_con">
    <div class="big_main_con">
        ...
        <!-- topbar here -->
        <form action="{{ route('Settings 2') }}" method="GET">
        <div class="row top_search_area" >
            <div class="col-7" style="margin:auto !important; ">
                <div class="input-group mb-3">
                    <input type="hidden" name="selected_tile" value="Settings">
                    <input class="form-control" type="search" placeholder="Search" name="search" onclick="submit_form()" aria-label="Search" value="{{ $search }}" aria-describedby="basic-addon2" style="display:none;">
        ...
        <div class="row inner_main_con">
            <div class="container tab_outer_con">
                <div class="row">
                    <label for="" class="title_con">Settings</label>
                </div>
                <div class="row tab_head_row">
                    <div class="col-3 " >
                        <form action="{{route('Settings')}}" method="GET"><input type="hidden" name="selected_tile" value="Settings"><button class="normal_tab" style="width:100%;">Admin Name List</button></form>
                    </div>
                    <div class="col-3" style="width:100%">
                        <button class="selected_tab" style="width:100%;" disabled>My Profile</button>
                    </div>
                </div>
                <div class="row tab_body_row" >
                    <div class="container tab_body_con" style="background-color:#eeefff;padding:60px;border-radius:20px;">
                        <div class="row">
                        {!! Form::open(['action' => ['App\Http\Controllers\AdminController@updateProfile', $posts->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                        <!--form-row-->
                                            ...
                                            <div class="form-group" style="">
                                                ...
                                                <div class="input-group" style="">
                                                    <span class="input-group-btn">
                                                        <span class="btn btn-default btn-file" style="margin-top:0px;margin-right:-1px;height:38px;width:150px;">
