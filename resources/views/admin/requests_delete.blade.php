...
<div class="col-9 big_con">
    <div class="big_main_con">
        ...
        <!-- topbar here -->
        <form action="{{ route('Requests 2') }}" method="GET">
        ...
        <div class="row inner_main_con">
            <div class="container tab_outer_con">
                ...
                <div class="row tab_head_row">
                    <div class="col-3 " >
                        <form action="{{route('Requests')}}" method="GET"><input type="hidden" name="selected_tile" value="Requests"><button class="normal_tab" style="width:100%;" >Request Verification</button></form>
                    </div>
                    <div class="col-3" style="width:100%">
                        <button class="selected_tab" style="width:100%;" disabled>Request Deletion</button>
                    </div>
                </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="center">
                                            ...
                                            <button class="btn_delete" data-toggle="modal" data-target=".bd-example-modal-sm-{{$var->reviewId}}">Delete</button>
                                        </td>
                                    </tr>
                                    @endforeach
                                    @endif
